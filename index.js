...
//
const BotName = 'RAGTQUEEN 🤖'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/ragtqueen'; // Nama Instagramlu cok
const whatsapplu = 'PERSONAL ONLY'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/DuGtUadR9xH0DIIZ5EG0A1'; // OFFICIAL GRUP LU 1
...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @ragtqueen`)
})
